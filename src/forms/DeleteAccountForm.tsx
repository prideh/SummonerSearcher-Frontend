...
const DeleteAccountForm = () => {
  ...
  return (
    <div className="bg-gray-800 p-6 rounded-lg shadow-md w-full max-w-sm mt-8">
      ...
      <button onClick={openModal} className="w-full bg-red-600 hover:bg-red-800 text-white font-bold py-2 px-4 rounded focus:shadow-outline">
        Delete My Account
      </button>
            ...
            <form onSubmit={handleDelete}>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  <input type={showPassword ? 'text' : 'password'} id="delete-password" value={password} onChange={(e) => setPassword(e.target.value)} className="shadow appearance-none border border-gray-600 rounded w-full py-2 px-3 bg-gray-700 text-gray-300 leading-tight focus:outline-none focus:shadow-outline focus:border-red-500 pr-16" required />
              ...
              <div className="flex items-center justify-end space-x-4">
                ...
                <button type="submit" disabled={isSubmitting} className="bg-red-600 hover:bg-red-800 disabled:bg-red-400 disabled:cursor-not-allowed text-white font-bold py-2 px-4 rounded focus:shadow-outline flex items-center">
