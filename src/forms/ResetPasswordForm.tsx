      ...
      <div className="flex items-start space-x-8">
        {isTokenValidating ? (
          <div className="bg-gray-900 p-6 rounded-lg shadow-md w-full max-w-sm text-center">
            <h2 className="text-2xl font-bold mb-4 text-gray-100">Verifying Token...</h2>
          ...
          <>
            <form onSubmit={handleSubmit} className="bg-gray-900 p-6 rounded-lg shadow-md w-full max-w-sm">
              <h2 className="text-2xl font-bold mb-4 text-gray-100">Reset Password</h2>
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  <input type={showPassword ? 'text' : 'password'} id="password" value={password} onChange={(e) => setPassword(e.target.value)} className="shadow appearance-none border border-gray-700 rounded w-full py-2 px-3 bg-gray-800 text-gray-300 leading-tight focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 pr-16" required />
